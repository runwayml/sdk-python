...
__all__ = ["VoiceUpdateResponse", "Processing", "Ready", "Failed"]
...
VoiceUpdateResponse: TypeAlias = Annotated[Union[Processing, Ready, Failed], PropertyInfo(discriminator="status")]
